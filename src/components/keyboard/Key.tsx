...
export const Key = ({
    ...
    return (
        ...
        >
            ...
            >
                {header && (
                    <span className="p-0 b-0 m-0 auto text-xs w-full h-full text-nowrap justify-self-start row-start-1 row-end-2 col-start-1 col-end-4 group-hover:inline-block group-hover:truncate @md:underline ">
                        {header}
                    </span>
                )}
                {children}
